...
public class AddNewProviderCommand implements Command {
    private static final Logger LOGGER = LoggerFactory.getLogger(AddNewProviderCommand.class);
    private final SendBotMessageService sendBotMessageService;
    private final ProviderService providerService;
    private final BundleLanguage bundleLanguage;

    public AddNewProviderCommand(SendBotMessageService sendBotMessageService, ProviderService providerService, BundleLanguage bundleLanguage) {
