...
//            }
//        }
            Pageable firstPageWithTwoElements = PageRequest.of(prevPosition.getPage(), PrevPositionDTO.PAGE_SIZE);
...
//    void fillListResulSelection(long chatId, List<ServiceEntity> byDescriptionLike) {
//        InlineKeyboardMarkup inlineKeyboardMarkup = new InlineKeyboardMarkup();
